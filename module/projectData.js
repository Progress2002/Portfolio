...
export const projects = {
  ...
  three: {
    ...
    description1:
      "In this web application, users are able to see all the countries in the world on the homepage, filter countries by region, click on a country to see more information, and search for a country.",
    featured_image: {
      mobile: './images/countries.png',
      desktop: './images/countries.png',
    },
    technologies: [
      'React/Redux',
      'CSS3',
    ...
    links: {
      live: 'https://countires.onrender.com/',
      source_code: 'https://github.com/Progress2002/Country.git',
    },
  },
  four: {
  ...
  five: {
    ...
    description1:
      "This is a React application that allows users to add new notes by providing the title and text of the note. It also displays the date and time at which the note was taken.",
    featured_image: {
      mobile: './images/Keeper.png',
      desktop: './images/Keeper.png',
    },
    technologies: [
      'React',
      'CSS3',
    ...
    links: {
      live: 'https://keeper-v8lq.onrender.com/',
      source_code: 'https://github.com/Progress2002/Keeper.git',
    },
  },
  six: {
    ...
    "This is a solution to the Easybank landing page challenge on Frontend Mentor Frontend Mentor challenges help you improve your coding skills by building realistic projects.",
    featured_image: {
      mobile: './images/easybank.png',
      desktop: './images/easybank.png',
    },
    technologies: [
      'React',
      'Tailwind CSS',
